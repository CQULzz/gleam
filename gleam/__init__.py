try:
    ...
    # Allow importing submodules such as gleam.network.encoder in the Isaac Lab migration runtime,
    # where Isaac Gym-specific task registration is intentionally unavailable.
    task_registry = None
